		...
		extend: {
			...
			keyframes: {
				...
				'background-gradient': {
					...
					'33%': {
						transform: 'translate(var(--tx-2, -30%), var(--ty-2, -70%))'
					},
					'66%': {
						transform: 'translate(var(--tx-3, -70%), var(--ty-3, -30%))'
					},
					'100%': {
			...
			animation: {
				...
				'background-gradient': 'background-gradient calc(var(--background-gradient-speed, 0.5s) * 20) ease-in-out infinite alternate'
			},
			boxShadow: {
