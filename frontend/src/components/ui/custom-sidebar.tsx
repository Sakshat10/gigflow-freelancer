...
export const DesktopSidebar = ({
  ...
  return (
    <div
      className={cn(
        "hidden md:flex md:flex-col bg-background border-r flex-shrink-0 h-[calc(100vh-10rem)]",
        className
      )}
      style={{
...
export const SidebarLink = ({
  ...
  return (
    <Link 
      to={link.href}
      className={cn(
        "flex items-center px-3 py-3 gap-3 group/sidebar transition-colors duration-200 hover:bg-gray-100 rounded-md",
        className
      )}
      onClick={handleClick}
      {...props}
